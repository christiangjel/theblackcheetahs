import { FaBandcamp, FaInstagram, FaYoutube, FaFacebook, FaSpotify, FaLink } from "react-icons/fa"
...
export default function SocialLinks() {
  ...
  return (
    <div className="flex flex-row flex-wrap justify-center gap-4 md:gap-8 mt-6 mb-8 md:mb-0">
